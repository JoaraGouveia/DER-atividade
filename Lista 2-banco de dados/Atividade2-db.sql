...
insert into tb_pizzas (nome,preco,acompanhamento,composicao,id_categorias) 
values ("Abacaixi com queijo de bufalo",70.60,"Refrigerante 500ml","Queijo,Abaicaxi ,Queijo de bufulo,Oregano",5);
insert into tb_pizzas (nome,preco,acompanhamento,composicao,id_categorias) 
values ("Nutella",78.60,"Refrigerante 1L","Queijo,Nutella,Chocolate,massa",4);
