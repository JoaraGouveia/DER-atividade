...
values("Enolla Homes Araujo",15,"Manhã","123.900.234-89","Fundamental II","7º ano",9.0);

insert into db_registro_escola(nomeCompleto,idade,turno,cpf,nivelDeEnsino,serie,media)
values("Diana Pereira da Silva",15,"Manhã","190.878.120-26","Ensino médio","1º ano",8.0);

insert into db_registro_escola(nomeCompleto,idade,turno,cpf,nivelDeEnsino,serie,media)
values("Ernandes Ferreira Coelho",17,"Tarde","233.964.234-21","Fundamental I","5º ano",10.0);

insert into db_registro_escola(nomeCompleto,idade,turno,cpf,nivelDeEnsino,serie,media)
values("Izabela Costa Nascimento",7,"Manhã","123.800.234-46","Fundamental I","2º ano",9.0);

insert into db_registro_escola(nomeCompleto,idade,turno,cpf,nivelDeEnsino,serie,media)
values("Eduarda Almeida Pinto",17,"Manhã","267.476.230-11","Ensino médio","2º ano",6.5);

insert into db_registro_escola(nomeCompleto,idade,turno,cpf,nivelDeEnsino,serie,media)
values("Kauã da Silva Paula",17,"Manhã","290.486.120-11","Ensino médio","2º ano",9.5);
