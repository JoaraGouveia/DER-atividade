...
values("Gloss(Dior)",1900,60,7.90,400);

insert into db_ecommerce(produto,preco,estoque,frete,vendidos)
values("Pó banana",10.90,20,6.90,1000);

insert into db_ecommerce(produto,preco,estoque,frete,vendidos)
values("Fixador de maquiagem",23.30,90,11.87,6000);

insert into db_ecommerce(produto,preco,estoque,frete,vendidos)
values("Blush laranjinha",25.00,25,11.00,7900);
...
insert into db_ecommerce(produto,preco,estoque,frete,vendidos)
values("Batom(Dior)",600,4,0,68);

insert into db_ecommerce(produto,preco,estoque,frete,vendidos)
values("Rímel(Fenty)",15.90,90,20.89,1890);
